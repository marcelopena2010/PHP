...
<TABLE WIDTH=780 BORDER=0 CELLPADDING=0 CELLSPACING=0 align="center" class="main">
	...
	<TR>
		<TD COLSPAN=2 WIDTH=186 HEIGHT=33>
			<a href="http://"><img src="images/4.jpg" width=186 height=33 alt="" border=0></a></TD>
	</TR>
	<TR>
		<TD COLSPAN=2 WIDTH=186 HEIGHT=35>
			<a href="http://"><img src="images/5.jpg" width=186 height=35 alt="" border=0></a></TD>
	</TR>
	<TR>
		<TD COLSPAN=2 WIDTH=186 HEIGHT=39>
			<a href="http://"><img src="images/6.jpg" width=186 height=39 alt="" border=0></a></TD>
	</TR>
	<TR>
		<TD COLSPAN=2 WIDTH=186 HEIGHT=39>
			<a href="http://"><img src="images/7.jpg" width=186 height=39 alt="" border=0></a></TD>
	</TR>
	<TR>
	...
	<tr>
		<TD height="63" COLSPAN=2 valign="top" class="main">
				<IMG SRC="images/l1.jpg" WIDTH=338 HEIGHT=44 ALT=""><div align="center"><?php
			...
			$sql = "SELECT titulo, noticia FROM noticias WHERE id = $id_item";
